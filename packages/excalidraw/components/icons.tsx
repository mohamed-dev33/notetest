...
// AI Shape Recognition icon (tabler-icons: shape)
export const shapeRecognitionIcon = createIcon(
  <g strokeWidth={1.25}>
    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
    <path d="M5.5 4.5l13 0c.55 0 1 .45 1 1l0 13c0 .55 -.45 1 -1 1l-13 0c-.55 0 -1 -.45 -1 -1l0 -13c0 -.55 .45 -1 1 -1z" />
